...
namespace easy3d {
    ...
    public:
        ...
        void calculateQe(SurfaceMesh::Vertex v);
        void calculateCost(SurfaceMesh::Edge e);
        void update_Q_cost(SurfaceMesh::Vertex v);
        bool Qem_callapse(const Edge_priority& temp_edge);
        void Qem_Simplifiction();
