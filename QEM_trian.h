...
namespace easy3d {
	...
	public:
		...
		void initialize(int cur_id=0, float aspect_ratio = 0.0, float edge_length=0.0, unsigned int max_valence = 0, float normal_deviation = 0.0 );
	...
	public:
		void collapse_qem_LML(SurfaceMesh::Halfedge h);
